...
function ProductsPageContent() {
  ...
  const filters = { categorySlug, minPrice, maxPrice, brandId, inStock }
  ...
  const updateParams = useCallback(
    (updates: Record<string, string | undefined>) => {
      ...
      // Reset to page 1 when filters change (unless we're setting page)
      if (!("page" in updates)) {
        params.delete("page")
      }
  ...
  const handleFilterChange = useCallback(
    (update: Partial<typeof filters>) => {
      ...
      if ("categorySlug" in update) mapped.category = update.categorySlug || undefined
  ...
  useEffect(() => {
    ...
    fetchProducts()
  }, [page, sort, search, categorySlug, minPrice, maxPrice, brandId, inStock])
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-6">
      {/* Breadcrumb */}
      <Breadcrumb items={[{ label: "Urunler" }]} />

      <h1 className="mt-4 text-2xl font-bold text-foreground sm:text-3xl">Urunler</h1>
